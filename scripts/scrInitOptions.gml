///scrInitOptions()
//Game options
global.gameName = "I Wanna hear Okurimono Sunday!"; //Name that will be displayed on the game window
...
global.savePassword = "neos_avoidance"; //This will decide what password will be applied for encoding saves, the longer the password is the encryption will be more secure
...
//Misc. options
global.startRoom = rPreBoss; //The room where the game will start
global.useClearRoom = false; //If you wanna use the clear room (like a portal room) set this to true
global.clearRoom = rGameClear; //The room you wanna be sent to as a clear room
...
global.borderKills = false; //If the room border should kill you
